 ...
 * @author husak
 */
public class BoxIO extends DeviceGeneric {
    ...
    public BoxIO(String connectionName, String name, String type) {
    ...
    public synchronized void setDataByKey(String key, String data) {
        ...
        //System.out.println("BoxIO: " + key + ":" + data);
        int parsedData;
        try {
            switch (key) {
    ...
    public void publishHomeAssistentConfig(String topic) {
        ...
        ObjectNode device   = buildDeviceNode(mapper, "BoxIO");
        ...
        // Digital outputs do0–do5 (switch)
        for (int i = 0; i < 6; i++) {
            ObjectNode c = mapper.createObjectNode();
