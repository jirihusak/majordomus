 ...
 * Low-level RS-485 serial port abstraction using the jSerialComm library.
 * Opens a serial port at 115200 baud, transmits byte arrays, and receives
 * messages delimited by CR+LF (\r\n) via SerialPortMessageListener.
 *
