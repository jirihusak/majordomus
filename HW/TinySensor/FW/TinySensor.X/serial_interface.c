...
void send_response_data() 
{
    ...
    actual_len += sprintf(&(tx_buffer[actual_len]), ",t0:%d.%d,rh:%d.%d", 
            (int16_t)meas_values.temperature / 10, abs((int16_t)meas_values.temperature) % 10, (int16_t)meas_values.rHumidity / 10, abs((int16_t)meas_values.rHumidity) % 10);
...
//        actual_len += sprintf(&(tx_buffer[actual_len]), ",t2:%d.%d", 
//               meas_values.temperature_ext_1 / 10, abs(meas_values.temperature_ext_1) % 10);
//    }else
//    {
//        actual_len += sprintf(&(tx_buffer[actual_len]), ",t2:NaN");
//    }
//    
