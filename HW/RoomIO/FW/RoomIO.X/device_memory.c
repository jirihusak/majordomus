...
void device_memory_init()
{
    ...
    device_id_low = (uint32_t)mui_array[1] << 16;
    device_id_low = (device_id_low << 16) | (uint32_t)mui_array[0];
    
    device_id_high = (uint32_t)mui_array[3] << 16;
    device_id_high = (device_id_high << 16) | (uint32_t)mui_array[2];
